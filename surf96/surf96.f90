!
! Surface wave disperison kernel edited for fortran 90 compatibility 
! and C callability
!
! Based on surfdisp96.f that is part of pysurf96.
! https://github.com/miili/pysurf96
!
! Original license conditions for srfdis96.f
! http://www.eas.slu.edu/eqc/eqc_cps/CPS/cpslisc.html
! 
! 1. This agreement covers access to and use of sources of Computer Programs 
!    in Seismology distributed by the Department of Earth and Atmospheric Sciences 
!   of Saint Louis University.
!
! 2. This agreement authorizes access to and use of these sources for internal use only.
!
! 3. Sources may not be further distributed without written permission of the Department 
!    of Earth and Atmospheric Sciences of Saint Louis University.
!
! 4. The Department of Earth and Atmospheric Sciences of Saint Louis University provides 
!      no warranty for the said software.
!
! 5. This agreement is contingent upon the notification of the Department of Earth and  
!    Atmospheric Sciences of Saint Louis University of any modifications, bugfixes, etc.,
!
! 6. This agreement will remain in effect indefinitely or until both parties agree 
